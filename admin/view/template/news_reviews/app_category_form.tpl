				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
					...
					<div class="tab-content">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_h1]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['seo_h1'] : ''; ?>" placeholder="<?php echo $entry_seo_h1; ?>" id="input-seo-h1<?php echo $language['language_id']; ?>" class="form-control" />
										</div>
									</div>
									<div class="form-group">
						...
						<div class="tab-pane" id="tab-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<?php if ($error_keyword) { ?><div class="text-danger"><?php echo $error_keyword; ?></div><?php } ?>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-hidden"><?php echo $entry_hidden_category; ?></label>
								<div class="col-sm-10">
									<select name="hidden" id="input-hidden" class="form-control">
						...
						<div class="tab-pane" id="tab-links">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-parent-id"><span data-toggle="tooltip" title="<?php echo $help_autocomplete; ?>"><?php echo $entry_parent; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="category_parent" value="<?php echo $category_parent ?>" placeholder="<?php echo $entry_parent; ?>" id="input-parent-id" class="form-control" />
...
<script type="text/javascript"><!--
	// Manufacturer
	$('input[name=\'category_parent\']').autocomplete({
		...
		'select': function(item) {
			$('input[name=\'category_parent\']').val(item['label']);
...
$( document ).ready(function() {
	...
	$('#menu #app_category').addClass('active open');
});
//--></script>
<?php echo $footer; ?>